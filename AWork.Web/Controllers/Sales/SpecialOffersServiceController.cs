...
namespace AWork.Web.Controllers.Sales
{
    public class SpecialOffersServiceController : Controller
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            SpecialOfferForCreateDto spesial = new SpecialOfferForCreateDto();
            spesial.SpecialOfferProductForCreateDto.Add(new SpecialOfferProductForCreateDto() { ProductId = 1 });
