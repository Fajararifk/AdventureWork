...
namespace AWork.Web.Controllers.Sales
{
    public class SalesPersonsServiceController : Controller
    {
        ...
        public SalesPersonsServiceController(ISalesServiceManager serviceContext, IHumanResourceServiceManager HRContext, IPersonServiceManager personContext, ISalesRepositoryManager repositoryManager)
        {
        ...
        public async Task<JsonResult> GetDataEmployeeTypeSP(string name)
        {
            var result = await _repositoryManager.SalesPersonRepository.GetDataEmployeeTypeSP(name);
            return Json(result);
        }

        public async Task<JsonResult> GetDataTerritory(string name)
        {
            var result = await _repositoryManager.SalesPersonRepository.GetDataTerritoryByName(name);
            return Json(result);
        }
