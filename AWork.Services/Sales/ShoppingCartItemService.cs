...
namespace AWork.Services.Sales
{
    public class ShoppingCartItemService : IShoppingCartItemService
    {
        ...
        public async Task<IEnumerable<ShoppingCartItemDto>> GetCartItemByCustId(string custId, bool trackChanges)
        {
            var cartItem = await _repositoryManager.ShoppingCartItemRepository.GetCartItemByCustId(custId, trackChanges);
            var cartModel = _mapper.Map<IEnumerable<ShoppingCartItemDto>>(cartItem);
            return cartModel;
        }
